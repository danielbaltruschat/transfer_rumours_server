...
from relation_component import make_relation_extractor
from entity_resolver_component import make_entity_resolver

# make the config work
from relation_extraction import create_relation_model, create_classification_layer, create_tensors, create_instances_football
from entity_resolver_model import create_instances_resolver
